...
namespace Data.Migrations
{
    ...
    [Migration("20220725162751_userpostsinit")]
    partial class userpostsinit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "dd183716-fc49-4f66-9aa7-9a78009ea763",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "c9fddd59-d7b9-409f-bce8-bdf46cefeb84",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Models.Models.UserPosts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Models.UserPosts", b =>
                {
                    b.HasOne("Models.Models.Post", "Posts")
                        .WithMany("UserPosts")
                        .HasForeignKey("PostsId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Models.Models.ApplicationUser", "Users")
                        .WithMany("UserPosts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
